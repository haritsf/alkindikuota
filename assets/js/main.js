            ...
            e.default = (function() {
                if ("undefined" != typeof window) {
                    var t = ["scroll", "resize", "load"],
                        e = { history: [] },
                        n = { offset: {}, threshold: 0, test: u.inViewport },
        ...
        function(t, e, n) {
            ...
            t.exports = function(t, e, n) {
                function c(e) {
                    var n = m,
                        i = y;
                    return (m = y = void 0), (j = e), (g = t.apply(i, n));
                }
                function a(t) {
                    return (j = t), (b = setTimeout(p, e)), k ? c(t) : g;
                }
                function l(t) {
                    var n = t - j,
                        i = e - (t - w);
                ...
                function h(t) {
                    return (b = void 0), T && m ? c(t) : ((m = y = void 0), g);
                }
                function v() {
                    var t = o(),
                        n = d(t);
                    if (((m = arguments), (y = this), (w = t), n)) {
                        ...
                        if (O) return (b = setTimeout(p, e)), c(w);
                    }
                    return void 0 === b && (b = setTimeout(p, e)), g;
                }
                var m,
                    y,
                    x,
        ...
        function(t, e, n) {
            ...
            t.exports = function(t, e, n) {
                ...
                return (
                    ...
                    i(t, e, { leading: u, maxWait: e, trailing: s })
                );
            };
        },
        function(t, e) {
    ...
    (function(t) {
        t(document).ready(function() {
            setTimeout(function() {
                ...
                inView(".ll-image").on("enter", function(t) {
                    void 0 !== t.dataset.imgSrc &&
                        t.setAttribute("src", t.dataset.imgSrc);
                }),
                    ...
                    e.preventDefault(),
                        void 0 !== e.target.dataset.scrollTo &&
                            t("html, body").animate(
                                {
                                    scrollTop:
                                        t(e.target.dataset.scrollTo).offset()
                                            .top - 150
                                },
                                1e3
                            );
