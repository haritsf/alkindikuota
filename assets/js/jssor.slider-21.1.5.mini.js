  ...
  var i = (k.$JssorSlider$ = function(p, hc) {
    ...
    function Dc() {
      ...
      m.call(
        ...
        -1,
        2,
        { $Easing: e.$EaseLinear, Be: { Db: bc }, pd: r },
        b,
        { Db: 1 },
        { Db: -2 }
      );
  ...
  k.$JssorCaptionSlideo$ = function(n, f, l) {
    ...
    function r(e, f, a) {
      b.a(f, function(h) {
        ...
        var i = { $Easing: g, $OriginalWidth: a.N, $OriginalHeight: a.R },
