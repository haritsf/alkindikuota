!(function(t) {
    ...
    function(t, e, i) {
        ...
        !(function(r) {
            (s = [i(2)]),
                void 0 !==
                    (n = "function" == typeof (a = r) ? a.apply(e, s) : a) &&
                    (t.exports = n);
        })(function(t, e) {
            function i() {
                ...
                u = function(e, i) {
                    t.data(e, "datepicker", this),
                        ...
                        this.component &&
                            ...
                            (this.component = !1),
                        (this.isInline =
                            !this.component && this.element.is("div")),
            ...
            u.prototype = {
                    ...
                    !0 === this.o.showOnFocus &&
                        ...
                        this.o.immediateUpdates &&
                            this._events.push([
                                this.element,
                                {
                                    "changeYear changeMonth": t.proxy(function(
                                        t
                                    ) {
                                        this.update(t.date);
                                    },
                        ...
                        (this._secondaryEvents = [
                            ...
                            [
                                t(document),
                                {
                                    "mousedown touchstart": t.proxy(function(
                                        t
                                    ) {
                                        this.element.is(t.target) ||
                                            this.element.find(t.target)
                                                .length ||
                ...
                _utc_to_local: function(t) {
                    ...
                    return (
                        e.getTimezoneOffset() !== t.getTimezoneOffset() &&
                            (e = new Date(
                                t.getTime() + 6e4 * e.getTimezoneOffset()
                            )),
                        e
                    );
                },
                ...
                place: function() {
                    ...
                    if (
                        ("auto" === f &&
                            (f = -n + p - i < 0 ? "bottom" : "top"),
                        this.picker.addClass("datepicker-orient-" + f),
                        "top" === f
                            ? (p -=
                                  i + parseInt(this.picker.css("padding-top")))
                            : (p += u),
                        this.o.rtl)
                    ) {
                        var g = s - (d + c);
                ...
                fillDow: function() {
                    if (this.o.showWeekDays) {
                        ...
                        for (
                            ...
                            (i += '<th class="dow'),
                                -1 !==
                                    t.inArray(e, this.o.daysOfWeekDisabled) &&
                                    (i += " disabled"),
                                (i +=
                                    '">' +
                                    m[this.o.language].daysMin[e++ % 7] +
                                    "</th>");
                        (i += "</tr>"),
                            this.picker
                ...
                fill: function() {
                    ...
                    if (!isNaN(r) && !isNaN(o)) {
                        ...
                        var g = i(r, o, 0),
                            y = g.getUTCDate();
                        g.setUTCDate(
                            y - ((g.getUTCDay() - this.o.weekStart + 7) % 7)
                        );
                        var w = new Date(g);
                        g.getUTCFullYear() < 100 &&
                            w.setUTCFullYear(g.getUTCFullYear()),
                ...
                navArrowsClick: function(e) {
                    ...
                    0 !== this.viewMode &&
                        (i *= 12 * v.viewModes[this.viewMode].navStep),
                        (this.viewDate = this.moveMonth(this.viewDate, i)),
                        this._trigger(
                            v.viewModes[this.viewMode].e,
                            this.viewDate
                        ),
                        this.fill();
                },
                ...
                weekOfDateIsDisabled: function(e) {
                    return (
                        -1 !==
                        t.inArray(e.getUTCDay(), this.o.daysOfWeekDisabled)
                    );
                },
                ...
                setViewMode: function(t) {
                    (this.viewMode = t),
                        this.picker
                            ...
                            .filter(
                                ".datepicker-" +
                                    v.viewModes[this.viewMode].clsName
                            )
                            .show(),
                        this.updateNavArrows(),
                        this._trigger(
            ...
            var m = (t.fn.datepicker.dates = {
                ...
                v = {
                    ...
                    parseDate: function(i, s, n, r) {
                        ...
                        if (
                            ("string" == typeof s && (s = v.parseFormat(s)),
                            s.toValue)
                        )
    ...
    function(t, e, i) {
        ...
        !(function(i) {
            (s = []),
                void 0 !==
                    (n = "function" == typeof (a = i) ? a.apply(e, s) : a) &&
                    (t.exports = n);
        })(function() {
            "use strict";
            function t(t) {
            ...
            function M(t, e, i) {
                if (!e) return !0;
                i.xSteps[t] =
                    w([i.xVal[t], i.xVal[t + 1]], e) /
                    y(i.xPct[t], i.xPct[t + 1]);
            ...
            function E(t, e) {
                if (!r(e))
                    throw new Error(
                        "noUiSlider (" + G + "): 'step' is not numeric."
                    );
                t.singleStep = e;
            }
            function N(t, e) {
                if ("object" != typeof e || Array.isArray(e))
                    throw new Error(
                        "noUiSlider (" + G + "): 'range' is not an object."
                    );
            ...
            function K(t, s, r) {
                ...
                function D(t, e) {
                    return (
                        !!s.tooltips[e] && u(t.firstChild, s.cssClasses.tooltip)
                    );
                }
                function b(t, e, i) {
                    ...
                    return "positions" === t
                        ...
                        ? i
                            ? e.map(function(t) {
                                  return lt.fromStepping(
                                      lt.getStep(lt.toStepping(t))
                                  );
                              })
                            : e
                        : void 0;
                    ...
                    return (
                        ...
                        i.forEach(function(a, r) {
                            ...
                            if (
                                ...
                                for (
                                    o = Math.max(o, 1e-7), c = w;
                                    c <= D;
                                    c = s(c, o)
                                ) {
                                    for (
                                        m =
                                            (f = (p = lt.toStepping(c)) - u) /
                                            t,
                                            y = f / (v = Math.round(m)),
                                            d = 1;
                                        d <= v;
                ...
                function C(t, e, i) {
                    ...
                    var r = ct.createElement("div"),
                        ...
                        h = [
                            s.cssClasses.valueHorizontal,
                            s.cssClasses.valueVertical
                        ],
                        d = [
                ...
                function M(t, e, i, a) {
                    ...
                    return (
                        t.split(" ").forEach(function(t) {
                            e.addEventListener(t, n, !!at && { passive: !0 }),
                                r.push([t, n]);
                        }),
                        r
                    );
                ...
                function T(t, e, i) {
                    ...
                    return (
                        (e = e || f(ct)),
                        (o || l) &&
                            ((a = t.clientX + e.x), (n = t.clientY + e.y)),
                        (t.pageOffset = e),
                        (t.points = [a, n]),
                        (t.cursor = o || l),
                        t
                ...
                function Y(t, e) {
                    ...
                    r.push.apply(r, o.concat(l, h)),
                        t.cursor &&
                            ((pt.style.cursor = getComputedStyle(
                                t.target
                            ).cursor),
                ...
                function P(t) {
                    ...
                    if (!1 === i) return !1;
                    s.events.snap ||
                        o(st, s.cssClasses.tap, s.animationDuration),
                        I(i, e, !0, !0),
                        H(),
                        V("slide", i, !0),
                        V("update", i, !0),
                ...
                function z(t, e, i, a, n, r) {
                    return (
                        K.length > 1 &&
                            (a &&
                                e > 0 &&
                                (i = Math.max(i, t[e - 1] + s.margin)),
                            n &&
                                e < K.length - 1 &&
                                (i = Math.min(i, t[e + 1] - s.margin))),
                        K.length > 1 &&
                            s.limit &&
                            (a &&
                                e > 0 &&
                                (i = Math.min(i, t[e - 1] + s.limit)),
                            n &&
                                e < K.length - 1 &&
                                (i = Math.max(i, t[e + 1] - s.limit))),
                        s.padding &&
                            (0 === e && (i = Math.max(i, s.padding)),
                            e === K.length - 1 &&
                                (i = Math.min(i, 100 - s.padding))),
                        (i = lt.getStep(i)),
                        !((i = l(i)) === t[e] && !r) && i
                    );
                }
                ...
                return (
                    (function(t) {
                        c(t, s.cssClasses.target),
                            0 === s.dir
                                ? c(t, s.cssClasses.ltr)
                                : c(t, s.cssClasses.rtl),
                            0 === s.ort
